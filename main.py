...
for factorpair in factors:
	...
	elif str((eval((str(factorpair).replace(" ", "").replace(",","+").split('+'))[0]+"-"+(str(factorpair).replace(" ", "").replace(",","+").split('+'))[1]))) == str(quadratic[0]+".0"):
		found_fpair = str(factorpair).replace("(", "").replace(")", "").replace(" ", "").replace(".0", "").split(",")

		if '-' not in factorpair:
			if (str((eval(str(factorpair).replace(" ", "").replace(",","+")))) == str(quadratic[0]+".0")) == False:
				if (str((eval(str(factorpair).replace(" ", "").replace(",","-")))) == str(quadratic[0]+".0")) == False:
					if (str((eval((str(factorpair).replace(" ", "").replace(",","+").split('+'))[0]+"-"+(str(factorpair).replace(" ", "").replace(",","+").split('+'))[1]))) == str(quadratic[0]+".0")) == False:
						negative_factorpair = '-'+str(factorpair)

						if str((eval(str(negative_factorpair).replace(" ", "").replace(",","+")))) == str(quadratic[0]+".0"):
							found_fpair = str(negative_factorpair).replace("(", "").replace(")", "").replace(" ", "").replace(".0", "").split(",")

						elif str((eval(str(negative_factorpair).replace(" ", "").replace(",","-")))) == str(quadratic[0]+".0"):
							found_fpair = str(negative_factorpair).replace("(", "").replace(")", "").replace(" ", "").replace(".0", "").split(",")

						elif str((eval((str(negative_factorpair).replace(" ", "").replace(",","+").split('+'))[0]+"-"+(str(factorpair).replace(" ", "").replace(",","+").split('+'))[1]))) == str(quadratic[0]+".0"):
							found_fpair = str(negative_factorpair).replace("(", "").replace(")", "").replace(" ", "").replace(".0", "").split(",")
